...
def collate_pool(dataset_list):
    ...
    batch_dij_ = []
    base_idx = 0
    for i, ((atom_fea, nbr_fea, nbr_fea_idx1, nbr_fea_idx2, num_nbr, dij_), (pos,cell_atoms,cell_crys), target_ddec,cif_id)\
...
class CIFData(Dataset):
    def __init__(self,root_dir,root_dir_pos,root_dir_cell,root_dir_ddec,csv_file,radius=6,dmin=0,step=0.2,random_seed=110):
        self.root_dir = root_dir
        self.root_dir_pos = root_dir_pos
        self.root_dir_cell = root_dir_cell
    ...
    def __getitem__(self,idx):
        ...
        cell = np.load(self.root_dir_cell+'/'+cif_id+'.npy').reshape(1,9)
        ...
        return (atom_fea, nbr_fea, nbr_fea_idx1, nbr_fea_idx2, num_nbr,dij_), (pos,cell_atoms,cell_crys), target_ddec,cif_id
